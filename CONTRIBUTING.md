# Contributing to Super Parakeet

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to Super Parakeet on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
| `needs-review` | Pull requests which need code review, and approval from maintainers or Super Parakeet team. |
| `under-review` | Pull requests being reviewed by maintainers or Super Parakeet team. |
